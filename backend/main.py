...
def evaluate_relevance(title: str) -> str:
...
def check_user_password_is_correct(db, name, pwd):
...
async def login_for_access_token(
    ...
    """login"""
    u = check_user_password_is_correct(db, form_data.username, form_data.password)
